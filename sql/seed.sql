...
(1, 'completed', '2024-01-15', '2024-01-16', '2024-02-02', 5, FALSE, 'Austen''s wit and social commentary are timeless. Elizabeth is iconic!', 279),
(2, 'completed', '2024-01-10', '2024-01-12', '2024-03-01', 4, FALSE, 'Dense but brilliant. The psychology of Raskolnikov is mesmerizing.', 671),
(3, 'completed', '2023-12-15', '2023-12-17', '2024-01-20', 5, FALSE, 'Gothic masterpiece. Jane Eyre remains one of my favorites.', 448),
(4, 'completed', '2024-02-01', '2024-02-03', '2024-03-25', 4, FALSE, 'Tolstoy at his finest. Epic in scope but deeply personal.', 964),
(5, 'completed', '2024-01-20', '2024-01-22', '2024-02-15', 4, FALSE, 'Passionate and dark. Emily Brontë''s only novel is haunting.', 323),
(6, 'reading', '2024-02-20', '2024-02-21', NULL, NULL, FALSE, 'Currently on page 412. Dostoevsky explores faith and morality brilliantly.', 412),
(7, 'reading', '2024-02-25', '2024-02-26', NULL, NULL, FALSE, 'Page 278. Dickens'' vivid characters bring Victorian England to life.', 278),
(8, 'completed', '2024-01-05', '2024-01-07', '2024-01-25', 5, FALSE, 'The original science fiction novel. Still captivating and terrifying.', 280),
(9, 'completed', '2023-12-01', '2023-12-05', '2024-01-10', 5, FALSE, 'Verne''s imagination knows no bounds. An adventure classic.', 488),
(10, 'completed', '2024-01-08', '2024-01-09', '2024-01-20', 4, FALSE, 'Brilliant time travel story. Simple but profound.', 109),
(11, 'completed', '2024-02-10', '2024-02-12', '2024-03-20', 5, FALSE, '1984 is more relevant than ever. A chilling masterpiece.', 328),
(12, 'tbr', '2024-03-01', NULL, NULL, NULL, TRUE, 'Can''t wait to read this epic fantasy. Building up to it.', 0),
(13, 'unread', '2024-02-28', NULL, NULL, NULL, FALSE, 'Huxley''s classic dystopia. Added to library, ready to read when I get to it.', 0),
(14, 'tbr', '2024-03-05', NULL, NULL, NULL, TRUE, 'A classic adventure. On my priority list.', 0),
(15, 'completed', '2024-01-25', '2024-01-27', '2024-02-20', 4, FALSE, 'Murder on a train. Christie at her best with Poirot.', 256),
(16, 'unread', '2024-03-02', NULL, NULL, NULL, FALSE, 'Modern mystery with unreliable narrators. Curious to see how it compares to classics.', 0),
(17, 'completed', '2024-01-30', '2024-02-01', '2024-02-18', 5, FALSE, 'Ten strangers, ten murders. A masterpiece of suspense.', 272),
(18, 'tbr', '2024-03-08', NULL, NULL, NULL, TRUE, 'The first detective novel ever written. Historical importance.', 0),
(19, 'unread', '2024-02-15', NULL, NULL, NULL, FALSE, 'Sherlock Holmes classic. Interested in revisiting the detective stories.', 0),
(20, 'completed', '2024-01-12', '2024-01-14', '2024-01-25', 4, FALSE, 'Jekyll and Hyde is Gothic perfection. Still disturbing.', 96),
(21, 'completed', '2024-02-05', '2024-02-07', '2024-02-25', 4, FALSE, 'Austen''s sense and sensibility balance in two sisters.', 409),
(22, 'completed', '2024-01-03', '2024-01-05', '2024-01-30', 5, FALSE, 'Fitzgerald captures the Jazz Age and the American Dream perfectly.', 180),
(23, 'tbr', '2024-03-10', NULL, NULL, NULL, TRUE, 'Emily Dickinson''s incredible poetry. Ready to be moved.', 0),
(24, 'unread', '2024-02-28', NULL, NULL, NULL, FALSE, 'Austen''s final novel. Want to read all her works eventually.', 0),
(25, 'unread', '2024-03-08', NULL, NULL, NULL, FALSE, 'A survival classic. Haven''t gotten to it yet.', 0),
(26, 'tbr', '2024-03-12', NULL, NULL, NULL, TRUE, 'Pirate adventure with treasure and mystery.', 0);
...
INSERT INTO reading_sessions (book_id, session_date, pages_read, duration_minutes) VALUES
(22, '2024-01-05', 65, 110),
(22, '2024-01-06', 58, 100),
(22, '2024-01-07', 57, 100);
...
INSERT INTO reading_sessions (book_id, session_date, pages_read, duration_minutes) VALUES
(11, '2024-02-12', 52, 105),
(11, '2024-02-14', 48, 95),
(11, '2024-02-16', 55, 110),
(11, '2024-02-18', 50, 100),
(11, '2024-02-20', 49, 100),
(11, '2024-02-22', 51, 105),
(11, '2024-02-24', 23, 45);

-- Murder on the Orient Express (256 pages, completed in 16 days)
INSERT INTO reading_sessions (book_id, session_date, pages_read, duration_minutes) VALUES
(15, '2024-02-01', 58, 110),
(15, '2024-02-03', 62, 120),
(15, '2024-02-05', 54, 105),
(15, '2024-02-07', 55, 110),
(15, '2024-02-09', 27, 55);

-- And Then There Were None (272 pages, completed in 18 days)
INSERT INTO reading_sessions (book_id, session_date, pages_read, duration_minutes) VALUES
(17, '2024-02-01', 65, 120),
(17, '2024-02-02', 58, 110),
(17, '2024-02-03', 60, 115),
(17, '2024-02-04', 52, 100),
(17, '2024-02-05', 37, 70);
